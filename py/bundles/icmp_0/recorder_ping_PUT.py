...
from difftest.testenv import get_put_rec_cfg, \
                             inject_icmp_rec_cmd_0
...
@ComponentFactory( 'recorder_ping_put_factory' )
# This component provides a generator service
@Provides( 'recorder_ping_service' )
...
@Instantiate( 'recorder_ping_put_instance' )
class PingRecorderImplPUT( Recorder ):
    def __init__( self ):
        rec_cfg = get_put_rec_cfg()
        rec_cfg = inject_icmp_rec_cmd_0( rec_cfg )
