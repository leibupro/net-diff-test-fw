...
@ComponentFactory( 'generator_tlshs_factory' )
# This component provides a generator service
@Provides( 'generator_tlshs_service' )
# Consume all ping generator services available (aggregate them)
@Requires( '_sub_services', 'generator_tlshs_base_service',
           aggregate = True )
# Automatically instantiate a component when this factory is loaded
@Instantiate( 'generator_tlshs_instance' )
class GeneratorTlsHs( AggregServiceBundle ):
    def __init__( self ):
