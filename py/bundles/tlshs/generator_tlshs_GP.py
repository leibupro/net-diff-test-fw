...
from difftest.testenv import get_gp_cfg, \
                             get_gp_gen_cfg, \
...
@ComponentFactory( 'generator_tlshs_gp_factory' )
...
@Instantiate( 'generator_tlshs_gp_instance' )
class TlsHsGeneratorImplGP( Generator ):
    def __init__( self ):
        platf_cfg = get_gp_cfg()
        gen_cfg = get_gp_gen_cfg( platf_cfg )
